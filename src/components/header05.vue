...
<div class="header">
    <div class="heaw">
        <div class="fl">懂球彩票</div>
        <div class="fm">{{ this.$store.state.rname }}</div>
    ...
    <div class="menuleft" style="position:restive" v-show="ismenu" v-bind:class="show?'active':''">
        ...
        <ul class="menuul">
            <li><router-link :to="{ name: 'disclaimer', params:{rname:'免责声明'}}"><i class="iconfont icon-ml02 mlico"></i><span class="mfont ">免责声明</span></router-link></li>
            <li><router-link :to="{ name: 'feedback', params:{rname:'意见反馈'}}"><i class="iconfont icon-ml01 mlico"></i><span class="mfont">意见反馈</span></router-link></li>
            <li><router-link :to="{ name: 'login', params:{rname:'我要登入'}}"><i class="iconfont icon-psd mlico"></i><span class="mfont">我要登入</span></router-link></li>
            <li><router-link :to="{ name: 'register', params:{rname:'我要注册'}}"><i class="iconfont icon-reg mlico"></i><span class="mfont">我要注册</span></router-link></li>
        </ul>
    </div>
