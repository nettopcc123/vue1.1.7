...
.heaw{
    background: -webkit-linear-gradient(#b1ba7a, #202020);
    background: -o-linear-gradient(#b1ba7a, #202020);
    background: -moz-linear-gradient(#b1ba7a, #202020);
    background: linear-gradient(#b1ba7a, #202020);
    display: block;
    position: fixed;
    z-index: 100;
    width:100%;
